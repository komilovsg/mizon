...
const dict = {
  ...
  "lp.after.1": { ru: "Дилер с телефона указывает товар, тонны, куда везти, водителя и машину", tg: "Дилер аз телефон мол, тонна, ҷои боркунӣ, ронанда ва мошинро нишон медиҳад", en: "From a phone the dealer states product, tons, destination, driver and truck", zh: "经销商用手机填写货物、吨数、送达地点、司机和车辆" },
  ...
  "order.contact.hint": { ru: "Ваше ФИО", tg: "ННН-и шумо", en: "Your full name", zh: "你的姓名" },
