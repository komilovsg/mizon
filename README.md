...
**[Открыть демо-стенд →](https://mizon-two.vercel.app)** · входа нет, открывается сразу на рабочем экране
...
## Главный экран — одна кнопка

<img src="assets/readme/m-dealer-home.png" alt="Главный экран: кнопка «Создать заявку» во весь экран и список заявок под ней" width="300" align="right">

Программой пользуются не операторы учётных систем, и лишнее на экране мешает им
больше, чем помогает. Поэтому открывается она сразу на рабочем экране: кнопка
«Создать заявку» во весь верх и общий список заявок под ней. Ни витрины,
ни входа, ни выбора роли.
...
Контрагента в поле «От кого» вводят строкой: знакомое имя подхватывается,
новое заводится само, а поле подсказывает уже известные названия.
